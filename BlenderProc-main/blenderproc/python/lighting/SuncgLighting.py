...
def light_suncg_scene(lightbulb_emission_strength: float = 15, lampshade_emission_strength: float = 7,
                      ceiling_emission_strength: float = 1.5, light_sources = ["lamp", "window", "ceiling"]):
    ...
    collection_of_mats: Dict[str, Dict[str, Material]] = {k: {} for k in light_sources} #{"lamp": {}, "window": {}, "ceiling": {}}
