...
def main(args):
    ...
    for scene in tqdm(scenes):
        # if '01e1d6b2-e3b3-4eb4-9969-b23088fab6a0_Bedroom-7308' not in scene:
        # if '00fe8139-76e8-42b4-bb41-7f9f085ac351_SecondBedroom-15597' not in scene:
        # if '003ac11d-2abc-44f8-9836-4354e7dfa543_Bedroom-1573' not in scene:
        # if '00ecd5d3-d369-459f-8300-38fc159823dc_MasterBedroom-6296' not in scene:
        # if '02cdd750-72be-4bc5-a033-3c604919009f_Bedroom-3064' not in scene:
        # if '02f7ad87-8aaf-49a0-bd98-c010e7b84c33_MasterBedroom-6210' not in scene:
        # if '02fb72ea-8e75-4f7b-85bd-18798232b263_SecondBedroom-40617' not in scene:
        # if '04e61b97-0a68-44c5-abae-5219c2d3f616_SecondBedroom-15023' not in scene:
        # if '004f900c-468a-4f70-83cc-aa2c98875264_SecondBedroom-27399' not in scene:
        if '05d05b98-e95c-4671-935d-7af6a1468d07_Bedroom-27402' not in scene:
        # if '0422e423-8aba-40f0-9090-78f448423468_MasterBedroom-131' not in scene:
            continue
...
def sample_camera_positions(scene_grid, bed_grid, room_layout, bed_center, max_coords, num_samples_scene=10,
                            camera_height=1.7, seed=0, top_perc=0.5, dist_perc=0.000, beds_only=False):
    np.random.seed(seed)
    ...
    l1_dist_max = l1_dist.amax(0)
    # print(l1_dist_max)
    # print("l1_dist", l1_dist.shape, l1_dist.amin(0), l1_dist.amax(0))
    valid_distance_ind = torch.where(torch.logical_and(torch.logical_and(torch.logical_and(l1_dist[:, 0] >= 0.1, l1_dist[:, 0] < 10.0), l1_dist[:, 2] >= 0.1), l1_dist[:, 2] < 10.0))[0]
    # valid_distance_ind = torch.where(torch.logical_and(torch.logical_and(torch.logical_and(l1_dist[:, 0] >= l1_dist_max[0], l1_dist[:, 0] < 500.0), l1_dist[:, 2] >= l1_dist_max[2]), l1_dist[:, 2] < 500.0))[0]
    ...
    # assert False
    # while len(path_astar) < num_samples_scene and i < min(valid_distance_ind.shape[0], 5000):
    ...
    #     start_coords = (195, 207)
    #     end_coords = (60, 207)
    #     in_valid_layout = (valid_layout == False).cpu().numpy().astype(int)
    #     # print(start_coords, end_coords)
    #     path_astar = astar(in_valid_layout, start_coords, end_coords)
    #     # print(len(path_astar), num_samples_scene)
    #     i+=1
    # coords_list = [((195, 48), (195, 207)), ((195, 207), (60, 207))] # 01e1d6b2-e3b3-4eb4-9969-b23088fab6a0_Bedroom-7308
    # coords_list = [((160, 195), (44, 195)), ((44, 195), (44, 130))] # 00fe8139-76e8-42b4-bb41-7f9f085ac351_SecondBedroom-15597
    # coords_list = [((100, 195), (44, 195)), ((44, 195), (44, 110)), ((44, 110), (100, 110))] # 003ac11d-2abc-44f8-9836-4354e7dfa543_Bedroom-1573
    # coords_list = [((194, 61), (194, 244))] #00ecd5d3-d369-459f-8300-38fc159823dc_MasterBedroom-6296
    # coords_list = [((194, 61), (194, 244))] #01e1d6b2-e3b3-4eb4-9969-b23088fab6a0_Bedroom-7308
    # coords_list = [((193, 45), (193, 210))] #02cdd750-72be-4bc5-a033-3c604919009f_Bedroom-3064
    # coords_list = [((65, 35), (65, 195))] #02f7ad87-8aaf-49a0-bd98-c010e7b84c33_MasterBedroom-6210
    # coords_list = [((59, 70), (59, 180))] #02fb72ea-8e75-4f7b-85bd-18798232b263_SecondBedroom-40617
    # coords_list = [((55, 196), (80, 100))] #04e61b97-0a68-44c5-abae-5219c2d3f616_SecondBedroom-15023
    # coords_list = [((60, 48), (60, 204))] #004f900c-468a-4f70-83cc-aa2c98875264_SecondBedroom-27399
    coords_list = [((73, 73), (180, 73)), ((180, 73), (180, 182)), ((180, 182), (73, 182))] #05d05b98-e95c-4671-935d-7af6a1468d07_Bedroom-27402
    # coords_list = [((80, 182), (60, 182)), ((60, 182), (60, 90))] #0422e423-8aba-40f0-9090-78f448423468_MasterBedroom-131
    # assert False
    path_astar = []
    ...
    # print(valid_coords_selected_smooth.shape)
    # assert False
    # valid_coords_selected_smooth = valid_coords_selected
