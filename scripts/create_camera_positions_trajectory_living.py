...
def main(args):
    ...
    # scenes= ["00c0c75e-1c12-46b3-9fc8-0561b1b1b510_LivingDiningRoom-1344"]
...
def sample_camera_positions(scene_grid, bed_grid, room_layout, bed_center, max_coords, num_samples_scene=10,
    ...
    path_astar = []
    i = 0
    while len(path_astar) < num_samples_scene and i < min(valid_distance_ind.shape[0], 10000):#200):
        # valid_distance_ind_chosen = valid_distance_ind[torch.randint(0, valid_distance_ind.shape[0], ())]
        valid_distance_ind_chosen = valid_distance_ind[i]
        indices_chosen = indices_combined[valid_distance_ind_chosen]
        # print("l1 dist", i, indices_chosen, l1_dist[indices_chosen[0]], l1_dist[indices_chosen[1]])
        ...
        # print(start_coords, end_coords, len(path_astar))
        i+=1
    if path_astar == []:
