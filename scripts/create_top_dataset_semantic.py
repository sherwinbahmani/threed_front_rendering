...
def main(in_dir, in_dir_ref, out_dir, label_name='masks', images_name='images', file_name='boxes.npz'):
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--out-dir",
        default="/path/to/data/3dfront/processed/bedrooms_without_lamps_full_9_fused_top_semantic"
    )
